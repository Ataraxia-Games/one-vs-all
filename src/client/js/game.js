...
Как играть за Predator-а (квадрат):
Цель: Убить всех Охотников
Управление:
WASD - движение, + Shift - бег
ЛКМ: Атака - Ближний бой
ПКМ: Ложный след - Создает эффект бега в точке курсора для отвлечения

Как играть за Hunter-а (круг):
Цель: Нанести последний удар Predator-у! Побеждает только добивший
Управление:
WASD - движение, + Shift - бег
ЛКМ: Стрельба
ПКМ: Сканер. Показывает границы Predator-а и его хп
